...
[![Unit tests](https://img.shields.io/badge/unit%20tests-497%20passing-brightgreen.svg)](tests/unit)
...
make lint && make test-unit   # gate: ruff+mypy clean, 497 unit tests, coverage ≥ 80%
...
| [`DEVIATIONS.md`](DEVIATIONS.md) | Every design decision vs. the paper, with rationale (96 entries) |
