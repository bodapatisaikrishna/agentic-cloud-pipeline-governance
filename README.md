...
[![Unit tests](https://img.shields.io/badge/unit%20tests-382%20passing-brightgreen.svg)](tests/unit)
...
make lint && make test-unit   # gate: ruff+mypy clean, 382 unit tests, coverage ≥ 80%
